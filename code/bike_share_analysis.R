...
df1 <- read_csv("..//case_study_1_bike-share//raw-data//202108-divvy-tripdata.csv")
df2 <- read_csv("..//case_study_1_bike-share//raw-data//202109-divvy-tripdata.csv")
df3 <- read_csv("..//case_study_1_bike-share//raw-data//202110-divvy-tripdata.csv")
df4 <- read_csv("..//case_study_1_bike-share//raw-data//202111-divvy-tripdata.csv")
df5 <- read_csv("..//case_study_1_bike-share//raw-data//202112-divvy-tripdata.csv")

df6 <- read_csv("..//case_study_1_bike-share//raw-data//202201-divvy-tripdata.csv")
df7 <- read_csv("..//case_study_1_bike-share//raw-data//202202-divvy-tripdata.csv")
df8 <- read_csv("..//case_study_1_bike-share//raw-data//202203-divvy-tripdata.csv")
df9 <- read_csv("..//case_study_1_bike-share//raw-data//202204-divvy-tripdata.csv")
df10 <- read_csv("..//case_study_1_bike-share//raw-data//202205-divvy-tripdata.csv")
df11 <- read_csv("..//case_study_1_bike-share//raw-data//202206-divvy-tripdata.csv")
df12 <- read_csv("..//case_study_1_bike-share//raw-data//202207-divvy-tripdata.csv")
